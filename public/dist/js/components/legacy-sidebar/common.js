(function($) {
    ...
    $(function () {
        ...
        $('.nav li', primarySidebar).each(function() {
            var $this = $(this);
        ...
        var flag = 0;
        primarySidebar.on('show.bs.collapse', '.collapse', function() {
            var parentIndex ='';
            if($(this).parents('div.collapse').length){
                flag = 1;
                parentIndex = $(this).parents('div.collapse').parent().index();
                primarySidebar.find('.collapse.show').each(function(){
        ...
        //Sidebar Toggle
        $('[data-toggle="lgy-sidebar"]').on("click", function() {
        ...
        //Sidebar Toggle
        $('[data-toggle="lgy-sb"]').on("click", function() {
